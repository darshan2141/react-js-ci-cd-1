...
const CustomBallTypeBottomSheet = ({
    isOpen,
    onDismiss,
    setBallType
}) => {
        ...
        >
            <div className="container">
                ...
                <div className="content">
                    <p className="sheet-header-text">{txt.ball_type}</p>
                    <p className="sheet-description-text">
                        {txt.select_the_desired_ball_type}
                    </p>

                    <div>
                        {
                            ballType.map((item, idx) => (
                                <div key={idx} style={{
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '5px',
                    ...
                    <div className="button-container">
                        <PrimaryButton onClick={() => {
                            if (typeof selectedBall === "number") {
                                onDismiss();
                                setBallType(ballType[selectedBall])
                            }
                        }}>
                            {txt.confirm}
                        </PrimaryButton>
...
export default CustomBallTypeBottomSheet